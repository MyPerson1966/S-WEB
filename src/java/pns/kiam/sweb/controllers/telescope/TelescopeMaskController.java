...
import pns.kiam.entities.telescopes.Utils.NumberUtils;
...
//    }
    ...
    public void rowSelectAction(TelescopeHorizontMask t) {
        ...
        TelescopeUtils.messageGenerator("Telescope Mask Selected", horizontMask.toString());
    ...
    public void onRowEdit(RowEditEvent event) {
        ...
        TelescopeUtils.messageGenerator("Telescope Mask Editeded. Result is: ", mask.toString());
    ...
    public void rowDeSelect() {
        horizontMask = null;
        selectedInfo = "";
        TelescopeUtils.messageGenerator("Telescope Mask Deselected  ", "...");
    ...
    public void removeRow(boolean all) {
        if (all) {
            ...
            TelescopeUtils.messageGenerator("Telescope " + telescope.getIdentifier(), "All masks removes");
        }
        if (!all && horizontMask != null) {
            ...
            TelescopeUtils.messageGenerator("Telescope " + telescope.getIdentifier(), "The mask " + horizontMask.toString() + " removes");
        }
...
//	System.out.println("  EM has Mask " + em.contains(tshm));
    ...
    private void initTelescopeMask() {
        angleRange = TelescopeUtils.generateDoubleArray(0, 90, 1);
        //angleRange = TelescopeUtils.generateDoubleArray(0, 20, 4);
        horizontRange = TelescopeUtils.generateDoubleArray(0, 360, 15);
